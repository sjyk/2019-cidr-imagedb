...
\begin{abstract}
Advances in deep learning have greatly widened the scope of automatic computer vision algorithms and are enabling users to ask questions directly about the content in images and video.
...
Our system, called \textsf{DeepLens}, is designed like a dataflow query processing system, and we use this research prototype to present initial experiments, and elicit some of the important open research questions in visual analytics systems.
One of our main conclusions isthat any future ``declarative'' VDMS will have to revisit query optimization and automated physical design from a unified perspective of performance and accuracy tradeoffs.
