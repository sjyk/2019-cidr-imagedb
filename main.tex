...
\title{DeepLens: Revisiting Multimedia Databases in the Era of Deep Learning}

\numberofauthors{1}
\author{ Sanjay Krishnan, Adam Dziedzic, Aaron Elmore \\
...
\begin{abstract}
Over the last two years, advances in deep learning have greatly widened the scope of automatic computer vision algorithms. 
In response, the community has built a number of visual analytics systems.
This paper takes the position that to scale such systems to increasingly complex tasks they should leverage classical relational database design principles.
A relational data model can greatly simplify the user-facing programming interface and provides insight into efficient execution of these programs. 
\textsf{DeepLens} is designed like a dataflow query processing system, and we use this research prototype to present initial experiments, and elicit some of the important open research questions in visual analytics systems.
\end{abstract}
